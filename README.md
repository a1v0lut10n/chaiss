...
- Immense thanks to the **Google Deepmind Team** and the **Gemini 3.1 Pro** model! Their mathematically advanced **Antigravity IDE** was the foundational tool that allowed me to engineer this AI-enabled chess application in a weekend.
